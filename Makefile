...
MKL_INCL = #
MKL_LIBS = #
GSL_INCL = -I/opt/homebrew/Cellar/gsl/2.7.1/include/ #-I/usr/local/include #-I$(PORTINCLUDE)
GSL_LIBS = -L/opt/homebrew/lib #-L/usr/local/lib #-L$(PORTLIB)
FFTW_INCL= -I/opt/homebrew/Cellar/fftw/3.3.10_1/include #/usr/local/include
FFTW_LIBS= -L/opt/homebrew/lib #/usr/local/lib
HDF5INCL = -I/opt/homebrew/Cellar/hdf5/1.14.0/include -DH5_USE_16_API #/usr/local/include -DH5_USE_16_API #-I$(PORTINCLUDE) -DH5_USE_16_API
HDF5LIB  = -L/opt/homebrew/lib -lhdf5 -lz #/usr/local/lib -lhdf5 -lz #-L$(PORTLIB)
MPICHLIB = -L/opt/homebrew/Cellar/open-mpi/4.1.4_2 #
